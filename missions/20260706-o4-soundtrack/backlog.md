...
- [ ]（討論閘前置，二選一，2026-07-11 定錨棒提案）補方向一 generate-ready prompt 包以滿足硬底線4「兩版都完整可生成」；或若確認方向一因 lyria-3 404 已無單段可行性、降為純備案，則走 MISSION 硬底線4 修訂提案（見 _blockers）改寫標準，讓文件與現實一致
