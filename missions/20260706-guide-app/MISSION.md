...
- 已收貨的開場頁原型（`assembly-guide-trial/`）＝視覺方向正錨，優化後的 app 要與它同一語彙。
- 動態/手勢類改動：無頭測試只算煙霧測試，一律標「待實機驗」。
- **視覺風格定調（2026-07-21 使用者裁決）**：工業風、暗色為主；禁用可愛風／卡通風，尤其 icon 使用時須特別注意不可流於可愛風格。全站主題、氛圍底圖、展品縮圖、hero 史料照、icon 一律依此方向統一。
