...
| 專案 | 日期 | 一句話 | 連結 |
|---|---|---|---|
| WTF | 2026-07-03 | remote session 網路白名單：WebFetch 對名單外全 403，研究驗證標準需降級為多來源交叉佐證＋標註未實開；巢狀 subagent 會卡「等子 agent」需 SendMessage 推進，交辦 prompt 應禁再派 | `_context/lessons-learned.md`（WTF repo） |
