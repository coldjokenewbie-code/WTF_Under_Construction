...
> - WTF_Under_Construction repo 在兩機 Git_work（唯一例外，不進 git_mirror）；Claude_cowork 專案的 Mac 路徑為 Google Drive「其他電腦」對 Windows 的鏡像。
...
| Remotion_fun | https://github.com/coldjokenewbie-code/Remotion_fun.git（branch master） | /Users/coma/git_mirror/Remotion_fun | E:\git_mirror\Remotion_fun（待搬） |
