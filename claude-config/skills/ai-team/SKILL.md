...
執行後在目標專案 `claude-config/` 建立以下檔案：
- `AI_TEAM_DIVISION.md` — 角色定義與分工矩陣
- `AI_TEAM_WORKFLOW.md` — 完整工作流與 handoff 格式
- `AGENT_SPEC_TEMPLATE.md` — 任務規格範本

這些文件由 Claude 在使用中逐步填入專案特定資訊。
